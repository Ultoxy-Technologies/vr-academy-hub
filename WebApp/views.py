...
from AdminApp.models import PasswordResetOTP,PhotoGalleryCategories, PhotoGallery, VideoGallery,FreeCourse,Basic_to_Advance_Cource,Advance_to_Pro_Cource,Certificate
